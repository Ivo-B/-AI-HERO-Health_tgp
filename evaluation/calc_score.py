...
if __name__ == '__main__':
    ...
    parser.add_argument('--preds', type=str,
                        default='/hkfs/work/workspace/scratch/im9193-H5/submission/predictions.csv')
    parser.add_argument('--gt', type=str, default='/hkfs/work/workspace/scratch/im9193-H5/data/valid.csv')
    parser.add_argument('--save_dir', type=str, default='/hkfs/work/workspace/scratch/im9193-H5/submission')
